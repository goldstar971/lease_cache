...
// misc parameters
// ---------------------------------------------------------------------------------------------------
`define STATE_HART_PIPELINE_DEPENDENCY_STALL	6'b100000 	
`define STATE_HART_PIPELINE_JUMP 				6'b000001


// source files
// ---------------------------------------------------------------------------------------------------
`include "../src/dependency_handler.v"
`include "../src/memory_reference_controller.v"
`include "../src/port_switch.v"
`include "../src/riscv_32I_alu.v"
`include "../src/riscv_32M_alu_pipelined.v"
`include "../src/riscv_alu_32M_converter.v"
`include "../src/riscv_alu_pipelined.v"
`include "../src/stage1_instruction_decode.v"
`include "../src/stage4_memory_operation.v"
`include "../src/target_address_generator.v"
`include "../src/udivider32b.v"
`include "../src/umultiplier32b.v"
`include "../src/pipeline_data_buffer.v"
`include "../src/pipeline_instruction_buffer.v"
`include "../src/riscv_hart_6stage_pipeline_2stage_cache.v"
`include "../src/memory_request_orderer.v"
