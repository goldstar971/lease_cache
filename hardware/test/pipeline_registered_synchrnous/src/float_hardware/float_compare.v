...
//altfp_compare CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" PIPELINE=3 WIDTH_EXP=8 WIDTH_MAN=23 aeb alb aleb clock dataa datab
...
module  float_compare_altfp_compare_oob
	( 
	aeb,
	alb,
	aleb,
...
endmodule //float_compare_altfp_compare_oob
//VALID FILE
...
module float_compare (
	...
	float_compare_altfp_compare_oob	float_compare_altfp_compare_oob_component (
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
				.aeb (sub_wire0),
