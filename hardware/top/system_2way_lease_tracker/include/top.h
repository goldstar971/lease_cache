...
`ifdef DATA_CACHE_FA
	...
	`ifdef 	DATA_POLICY_LEASE
		`define DATA_CACHE_INST 		lease_cache__tracker_2
	`else
...
`elsif DATA_CACHE_2WAY
	...
	`ifdef 	DATA_POLICY_LEASE
		`define DATA_CACHE_INST 		lease_cache_2way_tracker
	`else
...
// do not touch
`define LEASE_POLICY_CONTROLLER_INST set_cache_lease_policy_controller_tracker
/*`ifdef LEASE_PRIORITY
	`define LEASE_POLICY_CONTROLLER_INST fa_cache_lease_priority_policy_controller
`else 
