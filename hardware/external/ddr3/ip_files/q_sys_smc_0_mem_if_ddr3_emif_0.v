// q_sys_smc_0_mem_if_ddr3_emif_0.v
...
`timescale 1 ps / 1 ps
module q_sys_smc_0_mem_if_ddr3_emif_0 (
	...
	q_sys_smc_0_mem_if_ddr3_emif_0_pll0 pll0 (
        ...
        /*.pll_risc_50_clk           (risc_50_clk),
        .pll_risc_40_clk           (risc_40_clk),
        .pll_risc_30_clk           (risc_30_clk),
        .pll_risc_20_clk           (risc_20_clk),
        .pll_risc_10_clk           (risc_10_clk)*/
	);

	q_sys_smc_0_mem_if_ddr3_emif_0_p0 p0 (
		.global_reset_n              (global_reset_n),                     //        global_reset.reset_n
	...
	q_sys_smc_0_mem_if_ddr3_emif_0_s0 s0 (
		.avl_clk                     (p0_avl_clk_clk),                               //          avl_clk.clk
		.avl_reset_n                 (p0_avl_reset_reset),                           //        avl_reset.reset_n
		.scc_clk                     (p0_scc_clk_clk),                               //          scc_clk.clk
	...
	q_sys_smc_0_mem_if_ddr3_emif_0_c0 c0 (
		.afi_reset_n         (afi_reset_n),                //    afi_reset.reset_n
		.afi_clk             (afi_clk),                    //      afi_clk.clk
		.afi_half_clk        (afi_half_clk),               // afi_half_clk.clk
	...
	q_sys_smc_0_mem_if_ddr3_emif_0_mm_interconnect_0 mm_interconnect_0 (
