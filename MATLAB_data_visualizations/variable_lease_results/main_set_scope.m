...
addpath("./data/scope_set_08_31_2020");
...
benchmark_names2 = ["atax","doitgen","floyd-warshall","2mm","3mm","mvt","nussinov"];
...
[data4,filenames4,policies4] = extract_data_sets(file_path4);
...
for i = 1:length(benchmark_names)
    ...
    data_bm4{i} = parse_name(data4, filenames4, benchmark_names2(i));
end
...
figure();
    for i = 1:7
        subplot(4,2,i)
            ...
            bar([data_bm{i}(1:end-1,25)';
                data_bm2{i}(1:end-1,25)';
                data_bm4{i}(1:end-1,25)']');
                ...
                str_1 = compose("%.3g/%.3g/%.3g\n",  100-data_bm{i}(1:end-1,17),...
                                                100-data_bm2{i}(1:end-1,17),...
                                                100-data_bm4{i}(1:end-1,17));
                
                temp_max = max(data_bm{i}(1:end-1,25),data_bm2{i}(1:end-1,25));
                temp_max2 = max(temp_max, data_bm4{i}(1:end-1,25));
                %temp_max2 = temp_max;
                
                ylim([0 1.3*max(temp_max2)]);
                
                t = text(1:length(data_bm{i}(1:end-1,7)),temp_max2, ...
                            str_1, ...
                            ...
                            %'fontweight','bold'); 
                if (i == 7)
                    legend('CARL-Static','PRL-Spatial','CARL-Scope');
                end
