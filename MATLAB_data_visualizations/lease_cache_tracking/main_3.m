...
figure();
set(gcf, 'Position',[100,100,1300,360]);     % [low left x, low left y, top right x, top right y]
%     ax_1=subplot(2,3,1);
...
%         ylim([0 128]);
    ax_2=subplot(1,2,1);
        ...
        s.EdgeColor = 'none';
        axis tight;
        title(strcat(algor1,'-Individual Cache Line Status'),'FontSize',20);
        ylabel('Cache Line','FontSize',14);
        xlabel('Millions of accesses','FontSize',17);
        ax = gca;
		ax.FontSize=14;
        ax.XAxis.Exponent = 0;
		caxis([0,3]);
...
%         ylim([0 128]);
    ...
    ax_4=subplot(1,2,2);
        ...
        s.EdgeColor = 'none';
        axis tight;
        title(strcat(algor2,'-Individual Cache Line Status'),'FontSize',20);
        ylabel('Cache Line','FontSize',17);
        xlabel('Millions of accesses','FontSize',17);
        ax = gca;
			ax.FontSize=14;
        ax.XAxis.Exponent = 0;
