...
if(contains(benchmark,'floyd-warshall'))
	[average,exp_mat,trace]=extract_tracking_data_2_very_large_set(current_tracking_file,128);
else
...
set(gcf, 'Position',[100,100,1000,600]);     % [low left x, low left y, top right x, top right y]
    ...
    ax_2=subplot(1,3,2:3);
        ...
        set(ax_1,'Position',[pos(1) 1.09*pos(2) pos(3) .99*pos(4)],'FontSize',15);
        pos = get(ax_2,'Position');
        set(ax_2,'Position',[pos(1) 1.09*pos(2) pos(3) .99*pos(4)],'FontSize',15);
